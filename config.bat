...
if "%IS_ADMIN%"=="0" (
  ...
  echo.Please right-click the script and select '%CYAN%Run as administrator%RESET%'.
  pause
  exit /b 1
)
...
@REM @REM install Git (winget ID: Git.Git, command check: git, program folder: Git)
@REM call :Install-App "Git.Git" "Git" "git" "Git"
@REM @REM Check for .bashrc file
@REM call :Check-Bashrc

@REM @REM install Firefox (winget ID: Mozilla.Firefox, command check: firefox, program folder: Mozilla Firefox)
@REM call :Install-App "Mozilla.Firefox" "Firefox" "firefox" "Mozilla Firefox"

@REM @REM install Google Chrome
@REM call :Install-App "Google.Chrome" "Google Chrome" "chrome" "Google"


@REM @REM install Visual Studio Code (winget ID: Microsoft.VisualStudioCode, command check: code, program folder: Microsoft VS Code)
@REM call :Install-App "Microsoft.VisualStudioCode" "Visual Studio Code" "code" "Microsoft VS Code"
